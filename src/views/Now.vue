<template>
  <div class="now">
    <h3 class = "ScheduleFormat" >{{getGreeting()}}. Today is {{getCurrentScheduleName()}}.</h3> 
...
export default class Now extends Vue {
  ...
  getCurrentDate() {
    return DateTime.local().setZone("America/Los_Angeles").plus(Duration.fromMillis(plus_days * 86400000)).toLocaleString(DateTime.DATE_HUGE);
   }
