  ...
  <div class="home">
    ...
    <div class="grid-fmr">
      ...
      <div class="grid-fmr-value">
        ...
        <div class="cd-txt-h">({{Math.round(getCurrentPercentage() * 100)}}% until {{getUntilNextName()}})</div>
      </div>
    </div>
    <div class="grid-fmr">
    ...
    <br/>
    <p>Have feature suggestions? Send us a quick email at <a href="mailto:team@lciteam.club">team@lciteam.club</a>.</p>
  </div>
</template>
