...
export const HSBackToSchoolNight: any[] = [
  ...
  { start: toTime(19, 30), end: toTime(19, 40), period: Period.PERIOD_3 },
  { start: toTime(19, 40), end: toTime(19, 45), period: Period.PERIOD_3_PASSING },
  { start: toTime(19, 45), end: toTime(19, 55), period: Period.PERIOD_4 },
